...
if (!function_exists('curl_init')) {
  throw new Exception('1PEY needs the CURL PHP extension.');
}
if (!function_exists('json_decode')) {
  throw new Exception('1PEY needs the JSON PHP extension.');
}
if (!function_exists('mb_detect_encoding')) {
  throw new Exception('1PEY needs the Multibyte String PHP extension.');
}
